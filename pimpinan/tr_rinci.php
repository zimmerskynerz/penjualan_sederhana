...
<div class="modal-dialog">
	...
	<div class="modal-content">
        <div class="modal-header">
			...
			<h5 class="modal-title" id="myModalLabel">Harga Kirim	: <?php echo $row4['tarif'] ?>,-</h5>
			<h5 class="modal-title" id="myModalLabel">Total Bayar	: <?php echo $row1['ttl_bayar'] ?>,-</h5>
			<h5 class="modal-title" id="myModalLabel">Bayar			: <?php echo $row1['bayar'] ?>,-</h5>
			<h5 class="modal-title" id="myModalLabel">Kembali		: <?php echo $row1['kembali'] ?> </h5>
	</div>
