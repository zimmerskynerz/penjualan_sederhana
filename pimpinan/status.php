		...
		<div class="sidebar">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
                         <br><br>
						<li><a href="status.php" class="active"><i class="fa fa-book"></i> <span>Status Pengiriman</span></a></li>
        ...
        <!-- NAVBAR -->
			<nav class="navbar navbar-default">
				<div class="container-fluid">
						...
						<?php echo "<td align='left'>".$row['nama_user']."</td>"; ?>
                                      ...
                                      <div class="modal-body">
										...
										<form class="form-horizontal" method="post" action="query_sql.php" enctype="multipart/form-data">
											...
											<div class="form-group">
											  <label for="inputnim" class="col-lg-2 control-label">Kode Pelanggan</label>
											  <div class="col-lg-10">
												<input class="form-control" readonly value="<?php echo $hasil_1; ?>" id="id_pelanggan" name="id_pelanggan" type="text" required>
											  </div>
											</div>
											<div class="form-group">
											...
											<div class="input-group">
											<input type="text" value="order" id="status"  name="status" hidden> 
											</div>
											<div class="input-group">
											<input type="text" value="belum dikirim" id="status_kirim" name="status_kirim" hidden> 
											</div>
											<div class="form-group">
        ...
        <div id="ModalDelete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								...
								<div class="panel-body">
									<table id="example1" class="table table-hover">
										...
										<tbody>
											<?php
                                $sql_tampil = "select registrasi.id_registrasi as kd_reg, pembelian.id_beli as kd_beli, pembelian.tgl_beli as tgl_beli, pelanggan.nama as penerima, 
								pelanggan.alamat as alamat, pelanggan.kota as kota, pelanggan.telp as telp, pembelian.total_harga as ttl_hrg, 
								ongkir.tarif as krm_hrg, sum(pembelian.total_harga + ongkir.tarif) as hrg_ttl, pembelian.status_kirim as status from pelanggan, pembelian, registrasi, 
								ongkir where pembelian.id_beli=registrasi.id_beli and registrasi.id_ongkir=ongkir.id_ongkir and pelanggan.id_pelanggan=pembelian.id_pelanggan";
                            ...
                            <tr>
								...
								<td>
                                    <a href="#" class='btn btn-warning open_modal' id='<?php echo $data['kd_beli']; ?>'><span class="lnr lnr-pencil"></span></a>
                                </td>								
                            </tr>
                            <?php
