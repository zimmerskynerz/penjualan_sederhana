		...
		<div class="sidebar">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
                         <br><br>
						<li><a href="pegawai.php" class="active"><i class="fa fa-book"></i> <span>Daftar Pegawai</span></a></li>
						<li><a href="pelanggan.php" class=""><i class="fa fa-book"></i> <span>Daftar Pelanggan</span></a></li>
        ...
        <div id="ModalDelete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								...
								<div class="panel-body">
									<table id="example1" class="table table-hover">
										...
										<tbody>
											<?php
                                $sql_tampil = "select * from tb_user where status='ada' and level='kasir' or level='gudang'";
