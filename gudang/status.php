	...
	<div id="wrapper">
		...
		<div class="sidebar">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<br><br>
						<li><a href="status.php" class="active"><i class="fa fa-book"></i> <span>Status Terikirim</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Status Barang Diterima</h3>
					<div class="row">
						...
						<tbody>
							...
							$sql_tampil = "select tb_transaksi.id_beli as id_beli,
												...
												WHERE tb_transaksi.id_user=tb_user.id_user
												  AND tb_transaksi.status_kirim='diterima'
												  OR  tb_transaksi.status_kirim='dikirim'
												  AND tb_transaksi.status='ada'
												  GROUP BY tb_transaksi.id_beli";
